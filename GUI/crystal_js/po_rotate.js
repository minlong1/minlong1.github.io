...
"use strict";
    ...
    var version, print, arange, __name__, type, ρσ_ls, scene5, U, L, la_int, ra_int, rb_int, la_default_text, ra_default_text, rb_default_text, scale_factor, scale_default_text, la, unit, ra, ra_item, rb_item, cylinder_item, total_item, running, opatom, opbar, it0, b1, b2, it1, ib1, it2, ib2, it3, ib3, it5, ib5, ib6, ib7, it8, b;
    ...
    async function gen_csv() {
        ...
        for (var ρσ_Index1 of ρσ_Iter1) {
            i = ρσ_Index1;
            "79";
            (await file.write(str(0)["+"](",")["+"](str(ra_item[(typeof i === "number" && i["<"](0)) ? ra_item.length["+"](i) : i].pos.x))["+"](",")["+"](str(ra_item[(typeof i === "number" && i["<"](0)) ? ra_item.length["+"](i) : i].pos.y))["+"](",")["+"](str(ra_item[(typeof i === "number" && i["<"](0)) ? ra_item.length["+"](i) : i].pos.z))["+"](",")["+"](str(ra_item[(typeof i === "number" && i["<"](0)) ? ra_item.length["+"](i) : i].radius))["+"](",")["+"]("na\n")));
        }
        "82";
        (await file.write("#type,x,y,z,axis,length\n"));
        "83";
