...
"use strict";
    ...
    var version, print, arange, __name__, type, ρσ_ls, scene5, U, L, la_int, ra_int, rb_int, la_default_text, ra_default_text, rb_default_text, scale_factor, scale_default_text, la, unit, ra, ra_item, rb_item, cylinder_item, total_item, running, opatom, opbar, it0, it1, ib1, it2, ib2, it3, ib3, it5, ib5, ib6, ib7, it8, b;
    ...
    async function gen_csv() {
        ...
        for (var ρσ_Index1 of ρσ_Iter1) {
            i = ρσ_Index1;
            "79";
            file.write(str(0)["+"](",")["+"](str(ρσ_getitem(ra_item, i).pos.x))["+"](",")["+"](str(ρσ_getitem(ra_item, i).pos.y))["+"](",")["+"](str(ρσ_getitem(ra_item, i).pos.z))["+"](",")["+"](str(ρσ_getitem(ra_item, i).radius))["+"](",")["+"]("na\n"));
        }
        "82";
        ...
        for (var ρσ_Index2 of ρσ_Iter2) {
            ...
            "85";
            file.write(str(1)["+"](",")["+"](str(ρσ_getitem(cylinder_item, i).pos.x))["+"](",")["+"](str(ρσ_getitem(cylinder_item, i).pos.y))["+"](",")["+"](str(ρσ_getitem(cylinder_item, i).pos.z))["+"](",")["+"](str(axis_num))["+"](",")["+"](str(ρσ_getitem(cylinder_item, i).length))["+"]("\n"));
        }
        "87";
        file.close();
    };
    ...
    (await build(L, ra));
    "288";
    ρσ_interpolate_kwargs.call(this, wtext, [ρσ_desugar_kwargs({text: "<h2>Primitive Cubic Crystal System: metal Polonium (Po) </h2><hr>", pos: scene5.title_anchor})]);
    "292";
    ρσ_interpolate_kwargs.call(this, wtext, [ρσ_desugar_kwargs({text: "<b>Polonium</b> is a rare and highly radioactive metal. It has the simplest but also rare crystal structure\ncalled primitive cubic or the simple cubic denoted as \"cP\". This structure consists of the smallest repeating \npattern of the cube with one lattice point on each corner of the cube.", pos: scene5.title_anchor})]);
    "298";
    ρσ_interpolate_kwargs.call(this, wtext, [ρσ_desugar_kwargs({text: "<h3>Structure Parameters</h3>", pos: scene5.title_anchor})]);
    "312";
    ρσ_interpolate_kwargs.call(this, wtext, [ρσ_desugar_kwargs({text: "\n<ul><li><b>L</b>: An integer number showing the maximum coordinate where an atom/ion can be placed. \n<li><b>a</b>: The distance between 2 neighboring atoms/ions.</li><li><b><font color = \"green\">r_a<font color =\"black\"></b>: Atomic/ionic radius[<font color = \"Green\">Green<font color =\"black\">] </li><li><b>scale</b>: A parameter between 0 and 1 to control the representation styles of crystal structures. \nScale=1 generates a <b>hard-sphere model</b> for the atomic arrangement. Atoms/ions are thought of as \nbeing solid spheres having well-defined, realistic diameters.  \nScale<1 generates a <b>reduced sphere model</b> where atom/ions are represented by spheres with reduced \nsizes by the factor of “scale”.  </li></ul>", pos: scene5.title_anchor})]);
    "319";
